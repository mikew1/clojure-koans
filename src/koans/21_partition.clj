...
(meditations
  ...
  "If you need to, you can start each sequence with an offset"  ; [n step coll]
  (= '((0 1 2) (5 6 7) (10 11 12)) (partition 3 5 (range 13)))  ; into 3's, 5 steps apart

  "Consider padding the last sequence with some default values..." ; [n step pad coll]
  (= '((0 1 2) (3 4 5) (6 :hello)) (partition 3 3 [:hello] (range 7))) ; use pad to fill up the last coll.
