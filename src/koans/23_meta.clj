...
(def giants
  (with-meta 'Giants              ; not sure why this is quoted
...
(meditations
  ...
  (= 'Giants (vary-meta giants dissoc :league))     ; not sure why this is quoted
